...
curl -X POST http://localhost:8080/api/sessions -H "Content-Type: application/json" -H "X-API-KEY: super-secret-api-key" -d "{\"userId\":\"venkat\",\"sessionName\":\"My First Session\"}"
"
